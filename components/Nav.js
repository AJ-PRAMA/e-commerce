...
export default function Nav({show}) {
  ...
  const activeLink = inactiveLink+' bg-pink text-pink-900 rounded-sm';
  ...
  return (
    <aside className={(show?'left-0':'-left-full')+" top-0 text-gray-500 p-4 fixed w-full bg-pink-100 h-full md:static md:w-auto transition-all"}>
